...
def main():
    ...
    # initWindow = Tk()
    # initWindow.title("Select game settings")
    # initWindow.geometry("400x400")
    ...
    # difficultyPrompt = Label(initWindow, "Choose your difficulty setting.")

    # for code in difficultyCodes:
    #     diff = Radiobutton(
    #         initWindow,
    #         text = difficultyCodes[0],
    #         value = difficultyCodes[1],
    #         variable = difficulty
    #     )
    
    # gridSize = DoubleVar()
    # gridSizePrompt = Label(initWindow, "Choose your grid size")
    # gridSizeSelector = Scale(
    #     initWindow,
    #     from_ = 5, to = 15,
    #     orient = 'vertical',
    #     variable = gridSize
    # )
    # gridSizeIndicator = Label(initWindow, "Currently selected grid size: " + gridSizeSelector.get())
    ...
    minesweeper = Minesweeper(gameWindow)
    # run event loop
    gameWindow.mainloop()
